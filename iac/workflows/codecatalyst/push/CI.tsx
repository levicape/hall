...
const APPLICATION = "greathall";
const CI_ENVIRONMENT = "c000";
const PUSH_IMAGE_ECR_STACK_OUTPUT = "greathall_codestar_ecr";
...
export const PULUMI_STACKS: Array<{
	stack: string;
	output: string;
	name?: string;
}> = [
	...
	{
		stack: "domains/qureau/http",
		name: "qureau-http",
	},
	{
		stack: "domains/qureau/monitor",
		name: "qureau-monitor",
	},
				...
				Integration: (
					<CodeCatalystActionGroupX>
						{{
							...
							[`Infrastructure_${CI_ENVIRONMENT}`]: (
								<CodeCatalystBuildX
									dependsOn={["Install"]}
									architecture={"arm64"}
									...
									inputs={{
										...
										Variables: [
											...
											...PULUMI_ENVIRONMENT,
											register("APPLICATION_IMAGE_NAME", APPLICATION),
											register("CI_ENVIRONMENT", CI_ENVIRONMENT),
										],
									}}
									outputs={{
										Artifacts: [
