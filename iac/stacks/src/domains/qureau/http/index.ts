...
const PACKAGE_NAME = "@levicape/greathall-qureau-io" as const;
const ARTIFACT_ROOT = "greathall-qureau-io" as const;
const HANDLER = "greathall-qureau-io/module/lambda/HttpHandler.handler";
...
export = async () => {
	...
	return all([
		...
		([
			...
			greathall_qureau_http_codepipeline,
